            ...
            <div className="mb-4 sm:mb-5">
              <div className="flex items-start mb-3">
                ...
                <div className="flex-1">
                  <h2 className="text-base xs:text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-[#074a5b] leading-tight mb-2" style={{ fontFamily: 'Comic Sans MS, cursive' }}>
                    {promotion.title}
                  </h2>
              ...
              <p className="text-sm xs:text-sm sm:text-base text-gray-600 leading-relaxed" style={{ fontFamily: 'Comic Sans MS, cursive' }}>
